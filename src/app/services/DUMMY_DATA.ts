...
issueData = [{
  ...
  {
    id: 27,
    title: 'bring back ng init to initialize a new blank workspace',
  ...
  {
    id: 28,
    title: 'Do we have breadcrumbs in Angular material\'s latest version.',
  ...
  {
    id: 41,
    title: 'Testing (ng test) fails on docker only',
  ...
  {
    id: 46,
    title: 'Provide better error location information (ng build --prod)',
